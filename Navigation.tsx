...
import ForumThreadScreen from './screen/citizen/forumThreadScreen';
...
const CitizenRoot = () => {
  ...
  return (
    <CitizenStack.Navigator screenOptions={{ headerShown: false }} >
      ...
      <CitizenStack.Screen name="ForumThreadScreen" component={ForumThreadScreen} options={{headerShown: false}}  />
